...
var username =  win.prompt("Qual o seu nome?") ? win.prompt("Qual o seu nome?") : "Desconhecido";
...
var email = win.prompt("Qual o seu email? ") ? win.prompt("Qual o seu email? ") : "";

/*
- Selecione o input de "Nome", atribuindo-o à uma variável chamada
`$inputUsername`.
*/
var $inputUsername = doc.querSelector('#name');

/*
- Selecione o input de "Email", atribuindo-o à uma variável chamada
`$inputEmail`.
*/
var $inputEmail = doc.querSelector('#email');

/*
- Selecione o campo de "Mensagem", atribuindo-o à uma variável chamada
`$message`.
*/
var $message = doc.querSelector('#message');

/*
- Selecione o botão de envio do formulário, atribuindo-o à uma variável
chamada `$button`.
*/
var $button = doc.querSelector('#button');
