...
console.log( text.replace(/Manuel Marques de Sousa/, "Rodrigo Talison") )
...
console.log(
 	text.replace( /O Centauro de Luvas/, function(x){
...
"13/06/1804". A primeira cois'a a fazer é criar uma função chamada
